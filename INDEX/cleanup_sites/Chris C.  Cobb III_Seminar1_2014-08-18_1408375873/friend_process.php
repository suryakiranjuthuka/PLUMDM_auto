		...
		<?php
			...
			<body style='max-width:100%;'>
			    ...
			    <h1 style='color:#253069'>New Friend Seminar Invite For Chris C.  Cobb III!!</h1>
			    </br>
			...
			//***(INSERT AGENT NAME)
			$subject = "Chris C.  Cobb III Friend Invite Sent";
			...
			<body style='max-width:100%;'>
			    ...
			    <h3>Hello ".$friend_name.",  I would like you to attend a seminar hosted by Chris C.  Cobb III with me. Chris C.  Cobb III is a financial planner that is hosting a complimentary seminar where these topics will be discussed:</h3>
			    <ul>
			    <li>-this</li>
			    <li>-that</li>
			    <li>-other stuff</li>
			    ...
			    <h3>If You Would Like To Reserve Your Spot Alongside Me, Or To Learn more Information <a href='www.cobb iiiseminar.com'>Click Here</a></h3>
			    <h3>Or Visit: www.cobb iiiseminar.com</h3>
			    </br>
			...
			//***(INSERT AGENT NAME)
			$headers1  = "From: Chris C.  Cobb III\r\n"; 
