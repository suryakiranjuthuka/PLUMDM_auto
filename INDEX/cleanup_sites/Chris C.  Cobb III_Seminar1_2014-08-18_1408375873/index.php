			...
			<html>
				<head>
					<title>Chris C.  Cobb III Seminar</title>
					...
					<script>
						...
						<header>
							<div id="logo_container"><h1>abc123 financial</h1></div>
						...
						<div id="banner">
							<div id="eventwrap">
								...
								<div id="datesContainer">
									...
									<div id="restaurant_text"><h1>abc123 steakhouse</h1></div>
									...
									<div id="restaurant1">
			                        	<h3>
			                        		<span id="street1">123 main st.</span></br>
			                        		<span id="city1">new york</span>
										</h3>
									</div>
					...
					<div id="contentwrapper">
						<div class="infosectionlarge"><h1 id="bio_title">about chris</h1>
							<p id="biography">chris is great...</p>
						</div>
						...
						<div class="infosection">
							...
							<ul>
								...
								<div id="bullet3"><li>-other stuff</li></div>
								<div id="bullet4"></div>
								<div id="bullet5"></div>
							</ul>
						</div>
