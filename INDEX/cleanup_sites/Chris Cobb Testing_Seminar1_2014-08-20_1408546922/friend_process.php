		...
		<?php
			...
			<body style='max-width:100%;'>
			    ...
			    <h1 style='color:#253069'>New Friend Seminar Invite For Chris Cobb Testing!!</h1>
			    </br>
			...
			//***(INSERT AGENT NAME)
			$subject = "Chris Cobb Testing Friend Invite Sent";
			...
			<body style='max-width:100%;'>
			    ...
			    <h3>Hello ".$friend_name.",  I would like you to attend a seminar hosted by Chris Cobb Testing with me. Chris Cobb Testing is a financial planner that is hosting a complimentary seminar where these topics will be discussed:</h3>
			    <ul>
			    <li>sadf</li>
			    <li>asdf</li>
			    <li>sdf</li>
			    ...
			    <h3>If You Would Like To Reserve Your Spot Alongside Me, Or To Learn more Information <a href='www.testingseminar.com'>Click Here</a></h3>
			    <h3>Or Visit: www.testingseminar.com</h3>
			    </br>
			...
			//***(INSERT AGENT NAME)
			$headers1  = "From: Chris Cobb Testing\r\n"; 
