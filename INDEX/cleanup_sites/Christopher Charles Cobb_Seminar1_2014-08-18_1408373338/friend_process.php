		...
		<?php
			...
			<body style='max-width:100%;'>
			    ...
			    <h1 style='color:#253069'>New Friend Seminar Invite For Christopher Charles Cobb!!</h1>
			    </br>
			...
			//***(INSERT AGENT NAME)
			$subject = "Christopher Charles Cobb Friend Invite Sent";
			...
			<body style='max-width:100%;'>
			    ...
			    <h3>Hello ".$friend_name.",  I would like you to attend this seminar hosted by Christopher Charles Cobb. Christopher Charles Cobb is a financial planner that is hosting a free seminar where these topics will be discussed:</h3>
			    <ul>
			    <li>how to optimize your gains</li>
			    <li>saving money</li>
			    <li>retire happy</li>
			...
			//***(INSERT AGENT NAME)
			$headers1  = "From: Christopher Charles Cobb\r\n"; 
