			...
			<html>
				<head>
					<title>Christopher Charles Cobb Seminar</title>
					...
					<script>
						...
						<header>
							<div id="logo_container"><h1>cobb financial</h1></div>
						
			            <div id="regphone" style="width:500px; position:relative;">
			                	Event Registration:
							<div id="seminar_number">123-456-7890</div>
						</div>
					</header>
					<div id="fullbanner">
						<div id="banner">
							<div id="eventwrap">
								<div id="event">
									<h1 id="inviteName"><span id="adv_name">cobb </span>Invites You</h1>
								...
								<div id="datesContainer">
									...
									<div id="restaurant_text"><h1>cobb house</h1></div>
									...
									<div id="restaurant1">
			                        	<h3>
			                        		<span id="street1">123123</span></br>
			                        		<span id="city1">123123</span>
										</h3>
									</div>
					...
					<div id="contentwrapper">
						<div class="infosectionlarge"><h1 id="bio_title">cobb is</h1>
							<p id="biography">a planner</p>
						</div>
						
						<div class="infosection">
							<div class="border"></div>
							<h1 id="bullet_title">what you will learn</h1>
							<ul>
								<div id="bullet1"><li>how to optimize your gains</li></div>
								<div id="bullet2"><li>saving money</li></div>
								<div id="bullet3"><li>retire happy</li></div>
								<div id="bullet4"></div>
								<div id="bullet5"></div>
							</ul>
						</div>
