		...
		if (isset($_POST["submit"])) {
			...
			<body style='max-width:100%;'>
			    ...
			    <h1 style='color:#253069;'>New Seminar Reservation For Christopher Charles Cobb!!</h1>
			    </br>
			    <h2>Name: ".$fullname."</h2>
			    <h2>Email: ".$email."</h2>
			    <h2>Phone: ".$phone."</h2>
			...
			$subject = "New Christopher Charles Cobb Seminar Lead";
			//who email is from
			...
			<body style='max-width:100%;'>
			    ...
			    <h2>Christopher Charles Cobb</h2>
			</body>
			</html>";
			//recipients
			$recipient1 = $email;
