		...
		<?php
			...
			<body style='max-width:100%;'>
			    ...
			    <h1 style='color:#253069'>New Friend Seminar Invite For Christopher Testing Cobb!!</h1>
			    </br>
			...
			//***(INSERT AGENT NAME)
			$subject = "Christopher Testing Cobb Friend Invite Sent";
			...
			<body style='max-width:100%;'>
			    ...
			    <h3>Hello ".$friend_name.",  I would like you to attend this seminar hosted by Christopher Testing Cobb. Christopher Testing Cobb is a financial planner that is hosting a free seminar where these topics will be discussed:</h3>
			    <ul>
			    <li>asdf</li>
			    <li>asdf</li>
			    <li>asdf</li>
			...
			$recipient1 = "cobb.chrisc@gmail.com";
			$subject1 = $friend_name.", ".$attendee_name." Would Like You To Join Us!";
			//***(INSERT AGENT NAME)
			$headers1  = "From: Christopher Testing Cobb\r\n"; 
