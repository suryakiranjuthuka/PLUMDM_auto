			...
			<html>
				<head>
					<title>Christopher Testing Cobb Seminar</title>
					...
					<script>
						...
						<header>
							<div id="logo_container"><img height="100" src="public/site_images/b2014-08-18_1408372580front.jpg" id="logo"></div>
						...
						<div id="banner">
							<div id="eventwrap">
								...
								<div id="datesContainer">
									...
									<div id="restLogoContainer"><img class="restlogo" height="70" src="public/site_images/r2014-08-18_1408372580cookbook_cover.jpg"></div>
							...
							<div id="form">
								...
								<form id="enroll_form" method="post" action="process.php">
									...
									<select name="date" id="date" required >
			                       		<option value="">--</option>
			                        	<option value="asdf">asdf</option><option value="asdf">asdf</option>
									</select></p>
					...
					<div id="contentwrapper">
						<div class="infosectionlarge"><img id="agent" width="200" src="public/site_images/p2014-08-18_1408372580cookbook_cover.jpg"><h1 id="bio_title">asdf</h1>
							<p id="biography">asdfsadf</p>
						</div>
						...
						<div class="infosection">
							...
							<ul>
								...
								<div id="bullet3"><li>asdf</li></div>
								<div id="bullet4"><li>asdf</li></div>
								<div id="bullet5"></div>
							</ul>
						</div>
					</div>
