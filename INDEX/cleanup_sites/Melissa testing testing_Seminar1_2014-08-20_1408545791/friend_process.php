		...
		<?php
			...
			<body style='max-width:100%;'>
			    ...
			    <h1 style='color:#253069'>New Friend Seminar Invite For Melissa testing testing!!</h1>
			    </br>
			...
			//***(INSERT AGENT NAME)
			$subject = "Melissa testing testing Friend Invite Sent";
			...
			<body style='max-width:100%;'>
			    ...
			    <h3>Hello ".$friend_name.",  I would like you to attend a seminar hosted by Melissa testing testing with me. Melissa testing testing is a financial planner that is hosting a complimentary seminar where these topics will be discussed:</h3>
			    <ul>
			    ...
			    <h3>If You Would Like To Reserve Your Spot Alongside Me, Or To Learn more Information <a href='www.plumdm.com/testingseminar'>Click Here</a></h3>
			    <h3>Or Visit: www.plumdm.com/testingseminar</h3>
			    </br>
			...
			//***(INSERT AGENT NAME)
			$headers1  = "From: Melissa testing testing\r\n"; 
