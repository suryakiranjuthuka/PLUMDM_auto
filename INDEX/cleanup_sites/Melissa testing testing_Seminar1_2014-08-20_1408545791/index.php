			...
			<html>
				<head>
					<title>Melissa testing testing Seminar</title>
					...
					<script>
						...
						<header>
							<div id="logo_container"><img height="100" src="public/site_images/b2014-08-20_1408545277logo.png" id="logo"></div>
						
			            <div id="regphone" style="width:500px; position:relative;">
			                	Event Registration:
							<div id="seminar_number">800-800-8000</div>
						</div>
					</header>
					<div id="fullbanner">
						<div id="banner">
							<div id="eventwrap">
								...
								<div id="datesContainer">
									<div style="display:inline-block;" id="date1">
										...
										<p id="date_1_date">December 05th</p>
									...
									<div id="restLogoContainer"><img class="restlogo" height="70" src="public/site_images/r2014-08-20_1408545277100 club.jpg"></div>
									...
									<div id="restaurant">
									<div id="restaurant1">
			                        	<h3><span id="rName1">123567 MAin Street </span></br>
			                        		<span id="street1">(across from YMCA)</span></br>
			                        		<span id="city1">Anytown, MA 02860</span>
										</h3>
									</div>
							...
							<div id="form">
								...
								<form id="enroll_form" method="post" action="process.php">
									...
									<select name="date" id="date" required >
			                       		<option value="">--</option>
			                        	<option value="December 05th">December 05th</option>
									</select></p>
					...
					<div id="contentwrapper">
						<div class="infosectionlarge"><img id="agent" width="200" src="public/site_images/p2014-08-20_1408545277cedernew.jpg"><h1 id="bio_title">Melissa Brrooks</h1>
						...
						<div class="infosection">
							...
							<h1 id="bullet_title">Check out our awesomely long seminar bulleted list:</h1>
							<ul>
