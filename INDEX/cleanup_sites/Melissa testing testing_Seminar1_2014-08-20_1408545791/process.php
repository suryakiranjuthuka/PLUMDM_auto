		...
		if (isset($_POST["submit"])) {
			...
			<body style='max-width:100%;'>
			    ...
			    <h1 style='color:#253069;'>New Seminar Reservation For Melissa testing testing!!</h1>
			    </br>
			    <h2>Name: ".$fullname."</h2>
			    <h2>Email: ".$email."</h2>
			    <h2>Phone: ".$phone."</h2>
			...
			$subject = "New Melissa testing testing Seminar Lead";
			//who email is from
