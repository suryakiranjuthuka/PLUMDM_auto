		...
		<?php
			...
			<body style='max-width:100%;'>
			    ...
			    <h1 style='color:#253069'>New Friend Seminar Invite For Surya 20!!</h1>
			    </br>
			...
			//***(INSERT AGENT NAME)
			$subject = "Surya 20 Friend Invite Sent";
			...
			<body style='max-width:100%;'>
			    ...
			    <h3>Hello ".$friend_name.",  I would like you to attend this seminar hosted by Surya 20. Surya 20 is a financial planner that is hosting a free seminar where these topics will be discussed:</h3>
			    <ul>
			    ...
			    <h3>If You Would Like To Reserve Your Spot Alongside Me, Or To Learn more Information <a href='www.20seminar.com'>Click Here</a></h3>
			    <h3>Or Visit: www.20seminar.com</h3>
			    </br>
