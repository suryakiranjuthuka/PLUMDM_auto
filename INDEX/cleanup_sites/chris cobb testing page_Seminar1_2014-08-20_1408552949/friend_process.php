		...
		<?php
			...
			<body style='max-width:100%;'>
			    ...
			    <h1 style='color:#253069'>New Friend Seminar Invite For chris cobb testing page!!</h1>
			    </br>
			...
			//***(INSERT AGENT NAME)
			$subject = "chris cobb testing page Friend Invite Sent";
			...
			<body style='max-width:100%;'>
			    ...
			    <h3>Hello ".$friend_name.",  I would like you to attend a seminar hosted by chris cobb testing page with me. chris cobb testing page is a financial planner that is hosting a complimentary seminar where these topics will be discussed:</h3>
			    <ul>
			    <li>1234</li>
			    <li>1234</li>
			    <li>1234</li>
			    ...
			    <h3>If You Would Like To Reserve Your Spot Alongside Me, Or To Learn more Information <a href='www.pageseminar.com'>Click Here</a></h3>
			    <h3>Or Visit: www.pageseminar.com</h3>
			    </br>
			...
			//***(INSERT AGENT NAME)
			$headers1  = "From: chris cobb testing page\r\n"; 
