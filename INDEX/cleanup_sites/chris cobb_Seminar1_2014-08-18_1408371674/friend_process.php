		...
		<?php
			...
			<body style='max-width:100%;'>
			    ...
			    <h1 style='color:#253069'>New Friend Seminar Invite For chris cobb!!</h1>
			    </br>
			...
			$recipient = "<landings@plumdm.com> , <cobb.chrisc@gmail.com> , carissa@plumdm.com";
			//***(INSERT AGENT NAME)
			$subject = "chris cobb Friend Invite Sent";
			...
			<body style='max-width:100%;'>
			    ...
			    <h3>Hello ".$friend_name.",  I would like you to attend this seminar hosted by chris cobb. chris cobb is an Financial planner that is hosting a free seminar where these topics will be discussed:</h3>
			    <ul>
			    <li>this</li>
			    <li>that</li>
			    <li>and this</li>
			    ...
			    <h3>If You Would Like To Reserve Your Spot Alongside Me, Or To Learn more Information <a href='www.plumdm.com/cobbseminar'>Click Here</a></h3>
			    <h3>Or Visit: www.plumdm.com/cobbseminar</h3>
			    </br>
