		...
		<?php
			...
			<body style='max-width:100%;'>
			    ...
			    <h1 style='color:#253069'>New Friend Seminar Invite For chris is testing cobb!!</h1>
			    </br>
			...
			$recipient = "<landings@plumdm.com> , <ccobb@umassd.edu> , carissa@plumdm.com";
			//***(INSERT AGENT NAME)
			$subject = "chris is testing cobb Friend Invite Sent";
			...
			<body style='max-width:100%;'>
			    ...
			    <h3>Hello ".$friend_name.",  I would like you to attend a seminar hosted by chris is testing cobb with me. chris is testing cobb is a financial planner that is hosting a complimentary seminar where these topics will be discussed:</h3>
			    <ul>
			    <li>dfvdsfv</li>
			    <li>sdfvdsfv</li>
			    <li>sdfv</li>
			    ...
			    <h3>If You Would Like To Reserve Your Spot Alongside Me, Or To Learn more Information <a href="www.cobbseminar.com">Click Here</a></h3>
			    <h3>Or Visit: www.cobbseminar.com</h3>
			    </br>
			...
			//***(INSERT AGENT NAME)
			$headers1  = "From: chris is testing cobb\r\n"; 
