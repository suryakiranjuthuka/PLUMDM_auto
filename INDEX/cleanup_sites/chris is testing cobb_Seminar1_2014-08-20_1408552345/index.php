			...
			<html>
				<head>
					<title>chris is testing cobb Seminar</title>
					...
					<script>
						...
						<header>
							<div id="logo_container"><h1>i[sdfg</h1></div>
						
			            <div id="regphone" style="width:500px; position:relative;">
			                	Event Registration:
							<div id="seminar_number">12342134123</div>
						</div>
					</header>
					<div id="fullbanner">
						<div id="banner">
							<div id="eventwrap">
								...
								<div id="datesContainer">
									...
									<div style="display:inline-block;" id="date2">
										<h3 id="date_2_day">234</h3>
										<p id="date_2_date">2134</p>
									...
									<div id="restaurant_text"><h1>dfg</h1></div>
							...
							<div id="form">
								...
								<form id="enroll_form" method="post" action="process.php">
									...
									<select name="date" id="date" required >
			                       		<option value="">--</option>
			                        	<option value="1234">1234</option><option value="2134">2134</option><option value="1234">1234</option>
									</select></p>
					...
					<div id="contentwrapper">
						<div class="infosectionlarge"><h1 id="bio_title">12341235</h1>
							<p id="biography">234egewgerg</p>
						</div>
						
						<div class="infosection">
							<div class="border"></div>
							<h1 id="bullet_title">fbdsfbq2134234</h1>
							<ul>
								<div id="bullet1"><li>dfvdsfv</li></div>
								<div id="bullet2"><li>sdfvdsfv</li></div>
								<div id="bullet3"><li>sdfv</li></div>
								<div id="bullet4"><li>dsfv</li></div>
								<div id="bullet5"></div>
							</ul>
						</div>
					</div>
