		...
		<?php
			...
			<body style='max-width:100%;'>
			    ...
			    <h1 style='color:#253069'>New Friend Seminar Invite For christo cobb!!</h1>
			    </br>
			...
			//***(INSERT AGENT NAME)
			$subject = "christo cobb Friend Invite Sent";
			...
			<body style='max-width:100%;'>
			    ...
			    <h3>Hello ".$friend_name.",  I would like you to attend a seminar hosted by christo cobb with me. christo cobb is a financial planner that is hosting a complimentary seminar where these topics will be discussed:</h3>
			    <ul>
			    <li>this</li>
			    <li>and that</li>
			    <li>and this</li>
