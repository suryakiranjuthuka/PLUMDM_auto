		...
		<?php
			...
			<body style='max-width:100%;'>
			    ...
			    <h1 style='color:#253069'>New Friend Seminar Invite For surya satish!!</h1>
			    </br>
			...
			$recipient = "<landings@plumdm.com> , <surya@gmail.com> , carissa@plumdm.com";
			//***(INSERT AGENT NAME)
			$subject = "surya satish Friend Invite Sent";
			...
			<body style='max-width:100%;'>
			    ...
			    <h3>Hello ".$friend_name.",  I would like you to attend a seminar hosted by surya satish with me. surya satish is a financial planner that is hosting a complimentary seminar where these topics will be discussed:</h3>
			    <ul>
			    ...
			    <h3>If You Would Like To Reserve Your Spot Alongside Me, Or To Learn more Information <a href='http://www.plumdm.com/satishseminar'>Click Here</a></h3>
			    <h3>Or Visit: http://www.plumdm.com/satishseminar</h3>
			    </br>
