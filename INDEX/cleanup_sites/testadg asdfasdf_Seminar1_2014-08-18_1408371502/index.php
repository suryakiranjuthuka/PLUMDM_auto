			...
			<html>
				<head>
					<title>testadg asdfasdf Seminar</title>
					...
					<script>
						...
						<header>
							<div id="logo_container"><h1>abcdefghij</h1></div>
					...
					<div id="fullbanner">
						<div id="banner">
							<div id="eventwrap">
								<div id="event">
									<h1 id="inviteName"><span id="adv_name">12341234 </span>Invites You</h1>
									<h2>to a complimentary <span id="meal">event</span></h2>
								<div id="datesContainer">
									<div style="padding: 0px 40px;" id="date1">
										<h3 id="date_1_day">1234</h3>
										<p id="date_1_date">34tdsfg</p>
										<p id="date_1_time">asdfsadf</p>
									</div>
									
									<div style="padding: 0px 40px;" id="date2">
										<h3 id="date_2_day">asdf</h3>
										<p id="date_2_date">asdf</p>
										<p id="date_2_time">asdf</p>
									</div>
									...
									<div id="restaurant_text"><h1>abfxbfg</h1></div>
									...
									<div id="restaurant1">
			                        	<h3>
			                        		<span id="street1">asdfasf</span></br>
			                        		<span id="city1">asdfasdf</span>
										</h3>
									</div>
							...
							<div id="form">
								...
								<form id="enroll_form" method="post" action="process.php">
									...
									<select name="date" id="date" required >
			                       		<option value="">--</option>
			                        	<option value="34tdsfg">34tdsfg</option><option value="asdf">asdf</option>
									</select></p>
					...
					<div id="contentwrapper">
						<div class="infosectionlarge"><img id="agent" width="200" src="public/site_images/p2014-08-18_1408371437cookbook_cover.jpg"><h1 id="bio_title">asdfasdf</h1>
							<p id="biography">asdfasdfasfsafsafsadfsadf</p>
						</div>
						
						<div class="infosection">
							<div class="border"></div>
							<h1 id="bullet_title">asdfasdf</h1>
							<ul>
								<div id="bullet1"><li>asdfasdf</li></div>
								<div id="bullet2"><li>asdfasdf</li></div>
								<div id="bullet3"><li>asdfasdf</li></div>
								<div id="bullet4"><li>asdfasfd</li></div>
								<div id="bullet5"><li>asdfasdf</li></div>
							</ul>
						</div>
					</div>
					<footer>
