...
$recipient = "<landings@plumdm.com> , <cobb.chrisc@gmail.com>";
//***(INSERT AGENT NAME)
$subject = "John Smith Friend Invite Sent";
...
<body style='max-width:100%;'>
    ...
    <h3>Hello ".$friend_name.", I would like you to attendChris Cobb&#39;s seminar with me. Chris Cobb is an Financial planner. He will be hosting a free seminar
    where he will discuss:</h3>
    <ul>
    <li>asdf</li>
    <li>asdfasdfsadf</li>
    <li>asdfsf</li>
    ...
    <h3>If You Would Like To Reserve Your Spot Alongside Me, Or To Learn more Information <a href=''>Click Here</a></h3>
    <h3>Or Visit: goggle.com</h3>
    </br>
