...
//logo variable
	if($_SESSION['b_logo'] != NULL){
		...
		$logo = '<img height="60" src="'. $_SESSION['b_logo'] . '" id="logo">';
		$b_logo_actual = '<img height="60" src="'. $b_logo . '" id="logo">';
	} else {
...
if($_SESSION['r_logo'] != NULL){
	...
	$restaurant = '<div id="restLogoContainer"><img class="restlogo" height="60" src="'. $_SESSION['r_logo'].'"></div>';
	$restaurant_actual = '<div id="restLogoContainer"><img class="restlogo" height="70" src="'. $r_logo.'"></div>'; 
} 
else if($_SESSION['r_name'] != NULL){
	$restaurant =  '<div id="restaurant_text">'. $_SESSION['r_name'] .'</div>'; 
...
if($_SESSION['p_logo'] != NULL){
	...
	$agent_actual =  '<img id="agent" width="150" src="'.$p_logo.'">';
}
...
if($_POST['submitDesignPopup']){
	...
	'../INDEX/cleanup_sites/'.$_SESSION['file_identifier'].'/'.$b_logo.'',
	'../INDEX/cleanup_sites/'.$_SESSION['file_identifier'].'/'.$r_logo.'',
	'../INDEX/cleanup_sites/'.$_SESSION['file_identifier'].'/'.$p_logo.''
	);
...
<html>
	<head>
		<meta charset="utf-8">
		<title>Edit Seminar 2</title>
		<link rel="shortcut icon" href="public/site_images/plum_logo-favicon.ico" >
		<link href='http://fonts.googleapis.com/css?family=Tangerine|Muli:400,400italic|Alegreya:400italic,400' rel='stylesheet' type='text/css'>
		<link href='http://fonts.googleapis.com/css?family=Great+Vibes|Alegreya:400italic,400' rel='stylesheet' type='text/css'>
		<link href="public/stylesheets/plumdm_auto_editor.css" rel="stylesheet" type="text/css">
		<link id="template_style" href="public/stylesheets/seminar2_purple.css" rel="stylesheet" type="text/css">
	...
	<body onload="popup()">
		...
		<section class="allShadow2" id="dashboard">
		    ...
		    <div id="swatches">
		    	...
		    	<a name="purple" class="transitionSwatch" onclick="swapStyleSheet1('public/stylesheets/seminar2_purple.css')"><div class="allShadow1 swatch" style="background-color:#44306E;"></div></a>
		        <a name="red" class="transitionSwatch" onclick="swapStyleSheet2('public/stylesheets/seminar2_red.css')"><div class="allShadow1 swatch" style="background-color:#612D29;"></div></a>
		    </div>
		    <hr></hr>
		    ...
		    <hr></hr>
		    <a href="upload_seminar2.php"><div class="transition1 bottomShadow" id="resetDesign">start over</div></a>
			<hr></hr>
		...
		<div id="wrapper">
			<div id="header">
				...
				<h2>to a complimentary <span id="2meal">dinner & seminar</span></h2>
			</div>
			<div id="leftcontent">
				<div id="event">
					...
					<div id="dates">
						...
						<div id="date1">
							...
							<div class="day">
								<h2 id="date_1_date">September</h2>
								<h1 id="date_1_number">21</h1>
							</div>
							<p class="weekday" id="date_1_day">Wednesday</p>
							<p class="time" id="date_1_time">6:00 p.m.</p>
							
							
						</div>
						<div id="or1" class="or" style="<?php if($_SESSION['r_two_name1'] != NULL){echo 'margin-left:25px; margin-right:25px;';} ?>">
							<p>or</p>
						</div>
						<div id="date2">
							<div class="day">
								<h2 id="date_2_date">September</h2>
								<h1 id="date_2_number">21</h1>
							</div>
							<p class="weekday" id="date_2_day">Wednesday</p>
							<p class="time" id="date_2_time">6:00 p.m.</p>
							
						</div>
						<div id="or2" class="or" <?php if($restaurant2 != ""){ echo 'style="display:none;"'; } ?>>
							<p>or</p>
						</div>
						<div id="date3" <?php if($restaurant2 != ""){ echo 'style="display:none;"'; } ?>>
							<div class="day">
								<h2 id="date_3_date">September</h2>
								<h1 id="date_3_number">21</h1>
							</div>
							<p class="weekday" id="date_3_day">Wednesday</p>
							<p class="time" id="date_3_time">6:00 p.m.</p>
							
						</div>
					</div>
							
						<div id="centerer_cont" style="width:100%; margin:auto; text-align:center; padding-top:50px; position:relative;"><?php echo $restaurant; ?></div>
				...
				<div id="bio">
					<div id="agentinfo">
					<?php if($_SESSION['p_logo'] != ""){ echo '<img id="agent" width="150" src="'. $_SESSION['p_logo'] . '">'; } ?>
					</div>
					<h2 id="bio_title">Your Host, John Smith of Smith & Smith</h2><div id="change_bio" class="edit_icon"></div>
					<p id="biography">Lorem ipsum dolor sit amet, elitr voluptatibus vim no, an dicit senserit consequuntur cum, nibh iudico oblique cu vix. Id dolorem reprimique per,
						 maiorum molestie suscipiantur et duo. Mea no dicat impetus. Sea velit facilisis et, ludus legere nec ad. Autem maiorum sed eu, id cibo vocibus sit, eam an aperiri denique.
						Sea velit facilisis et, ludus legere nec ad. Autem maiorum sed eu, id cibo vocibus sit, eam an aperiri denique.</p>
				</div>
			</div>
			<div id="rightcontent">
				...
				<div id="formcont">
				<h1>Register Now!</h1>
				<form method="post" action="process.php" style="position:relative;">
					<div id="example_form_cont"><h1 style="font-family:'Lato'; color: black; font-weight:bold; font-size:70px;" id="example_form">Example</h1></div>
						<input type="text" name="fullname" class="register" id="fullname" placeholder="Full Name*" disabled/>
						<input type="text" name="email" class="register" id="email" placeholder="Email Address*" disabled/>
						<input type="text" name="phone" class="register" id="phone" placeholder="Phone Number*" disabled />
						<input type="text" name="guestname" class="register" id="guestname" placeholder="Guest Name" disabled/>
						<select class="validate['required']" class="register" name="date" id="date" disabled>
                       		<option value="" selected="selected" disabled>Date</option>
				...
				<div id="bullets">
					...
					<h2 id="bullet_title">You Will Learn:</h2>
					<ul>
						<div id="bullet1"><li>Lorem ipsum dolor sit amet, Lorem ipsum dolor sit amet, Lorem ipsum dolor sit amet, Lorem ipsum dolor sit amet,</li></div>
			...
			<footer>
				<div id="logocontainer" style="margin:auto;"><?php echo $logo; ?></div>
				<p>Copyright 2014 Plum Direct Marketing</p>
			</footer>
		</div>
		...
		<div id="change_number" style="display:none; padding:10px; width:230px;">
			<label>Change Seminar Number:</label></br>
		    	<input type="text" id="sem_num_change" placeholder="xxx-xxx-xxxx" maxlength="13"></br>
		...
		<div id="change_seminar_information" style="display:none; padding:10px; width:315px;">
			<form onsubmit="event.preventDefault(); change_sem_info();">
		        <label>Event:</label></br>	
					<select id="2sem_meal_change" style="width:200px; height:24px; margin-bottom:2px;" required>
						<option value="">----</option>
						<option value="dinner & seminar">dinner & seminar</option>
						<option value="lunch & seminar">lunch & seminar</option>
						<option value="event">event</option>
					</select></br>
		        <label>Seminar Date #1:</label></br>
		            <input type="text" id="sem_date1_day_change" placeholder="Monday" style="width:90px" required>
		            <input type="text" id="sem_date1_date_change" placeholder="January" style="width:90px" required>
		            <input type="text" id="sem_date1_number_change" placeholder="21" style="width:30px" required>
		            <input type="text" id="sem_date1_time_change" placeholder="6:00 PM" style="width:50px" required></br>
		         <label>Seminar Date #2<?php if(!isset($_SESSION['r_two_name2'])){ echo ' (Optional):'; } ?></label></br>
		            ...
		            <input type="text" id="sem_date2_date_change" placeholder="January" style="width:90px"<?php if(isset($_SESSION['r_two_name2'])){ echo ' required';}  ?>>
		            <input type="text" id="sem_date2_number_change" placeholder="21" style="width:30px"<?php if(isset($_SESSION['r_two_name2'])){ echo ' required';}  ?>>
		            <input type="text" id="sem_date2_time_change" placeholder="6:00 PM" style="width:50px"<?php if(isset($_SESSION['r_two_name2'])){ echo ' required';}  ?>></br>
		            
		         <?php if(!isset($_SESSION['r_two_name2'])){ echo '   
		         <label>Seminar Date #3 (Optional):</label></br>
		            <input type="text" id="sem_date3_day_change" placeholder="Monday" style="width:90px">
		            <input type="text" id="sem_date3_date_change" placeholder="January" style="width:90px">
		            <input type="text" id="sem_date3_number_change" placeholder="21" style="width:30px">
		            <input type="text" id="sem_date3_time_change" placeholder="6:00 PM" style="width:50px"></br>
		            ';}?>
		            
		         <label>Seminar Location #1:</label></br>
		            <?php if($_SESSION['r_logo'] != NULL){ echo '<input type="text" id="1rName" placeholder="Restaurant Name" style="width:90px" required>' ; } ?>
		...
		<div id="change_seminar_bio" style="display:none; padding:10px; width:280px;">
		        ...
		        <label>Bio:</label></br>
		            <textarea id="2bio" style="border:1px solid lightgrey; resize:none; border-radius:9px; padding:3px; width:250px; height:170px;" placeholder="John is a financial advisor..."></textarea></br>
...
<script type="text/javascript">
	...
	function change_sem_bio(){
		...
		var text = document.getElementById("2bio").value;
		text = text.replace(/\r\n/g, '<br />').replace(/[\r\n]/g, '<br />');
	...
	function change_sem_info(){
		...
		var e = document.getElementById("2sem_meal_change");
		var meal = e.options[e.selectedIndex].value;
         		
		document.getElementById("2meal").innerHTML = meal;
		...
		document.getElementById("date_1_number").innerHTML = document.getElementById("sem_date1_number_change").value;
		//placehold do this..
		...
		//document.getElementById("sem_date1_date_change1").value = document.getElementById("sem_date1_date_change").value;
		document.getElementById("date_2_number").innerHTML = document.getElementById("sem_date2_number_change").value;
		//placehold do this..
		...
		//document.getElementById("sem_date1_date_change1").value = document.getElementById("sem_date1_date_change").value;
		document.getElementById("date_3_number").innerHTML = document.getElementById("sem_date3_number_change").value;
		//placehold do this..
		...
		if((document.getElementById("sem_date1_day_change").value == "")){
			...
			if((document.getElementById("sem_date2_day_change").value == "")){
				...
				document.getElementById("or1").style.display = "inline-block";
			...
			if((document.getElementById("sem_date3_date_change").value == "")){
				...
				document.getElementById("or1").style.marginLeft = "25px";
				document.getElementById("or1").style.marginRight = "25px";	
			}else{
				document.getElementById("original_date3").value = 1 ;
				document.getElementById("date3").style.display = "inline-block";
				document.getElementById("or2").style.display = "inline-block";
				document.getElementById("or1").style.marginLeft = "0px";
				document.getElementById("or1").style.marginRight = "0px";	
			}
	...
	$('#whats_this').qtip({ // Grab some elements to apply the tooltip to
		...
		$('#c_lp_client_lastname1').change(function() {
  			...
  			$("#default_url").html("www.plumdm.com/"+input+"seminar (FREE)");
  			$("#radio_default").val("www.plumdm.com/"+input+"seminar");
  			$("#custom_url").html("www."+input+"seminar.com ($50 FEE)");
  			$("#radio_custom").val("www."+input+"seminar.com");
		})
