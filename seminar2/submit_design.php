...
.transitionSwatch{
	...
	<body onload="clickBtn();">
		...
		<div style="position: absolute; top: 40%; text-align: center; width: 98%; font-family: 'Lato', Arial; font-size: 50px; color:#31071d; text-shadow: 1px 3px 3px rgba(0,0,0,0.3);">
			<h1>THANK YOU</h1>
			<h2 style="font-size: 30px; margin-top: 20px; text-shadow: 1px 3px 3px rgba(0,0,0,0.3);">Our Design Team Will Be Checking Your Design And Your Page Will Be Live Shortly!</h2>
		</div>
