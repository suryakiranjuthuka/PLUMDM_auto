<?php 
	...
	if(isset($_POST['upload_all'])){
		...
		header("Location: edit_seminar2.php");
...
<html>
	<head>
	<meta charset="utf-8">
	<title>Upload Personal Data Seminar 2</title>
...
<body>
	...
	<!-------------------------Bussiness LOGO------------------------------->
	<form id="form" action="upload_seminar2.php" method="POST" enctype="multipart/form-data" onsubmit="return checkSize(2097152)">
